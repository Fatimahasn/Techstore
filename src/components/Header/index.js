...
const Header =(props)=> {
  ...
  const {drawerType, locale, navigationStyle, horizontalNavPosition} = props;
  ...
  useEffect(()=>{
    if(props.authUser===true){
      setProfileImage("123");
      if (location.pathname !== '/techstore') {
  ...
  //       </li>
  //       <li className="jr-list-item">
  //           <Link className="jr-list-link" to="/techstore/login">
  //               <i className="zmdi zmdi-account zmdi-hc-fw"/>
  //               <span className="jr-list-text">
  //                 <IntlMessages id="sidebar.appModule.signin"/>
  //               </span>
  //           </Link>
  //       </li>
      ...
      <AppBar
        ...
        <Toolbar className="app-toolbar" disableGutters={false}>
          ...
          <Link className="app-logo mr-2 d-none d-sm-block" to="/">
            <img src={require("assets/images/tech_logo.jpg")} alt="Jambo" title="Jambo"/>
          </Link>
          ...
          <ul className="header-notifications list-inline ml-auto">
            <li className="list-inline-item">
              <Link to="/techstore">
                <IconButton className="icon-btn">
                    <i className="zmdi zmdi-home zmdi-hc-fw zmdi-hc-lg"/>
                </IconButton>
              </Link>
            </li>
            <li className="list-inline-item">
            ...
            <li className="list-inline-item">
              <Link to="/checkout">
                <IconButton className="icon-btn">
                    <i className="zmdi zmdi-shopping-cart zmdi-hc-fw zmdi-hc-lg"/>
                </IconButton>
              </Link>
            </li>
